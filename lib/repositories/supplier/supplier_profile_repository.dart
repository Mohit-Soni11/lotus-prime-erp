      ...
      final purchases = ledger.history
          .map(
            (item) => SupplierProfilePurchaseModel(
              ...
              inputCreditStatus: item.inputCreditStatus,
              ...
              metalFineDue: item.metalFineDue,
              metalFineDueValue: item.metalFineDueValue,
              metalFineCredit: item.metalFineCredit,
              metalFineCreditValue: item.metalFineCreditValue,
