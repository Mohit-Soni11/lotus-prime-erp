...
//               All actions: tap for detail, quick-release button.
// =============================================================================
...
class _GirviListScreenState extends State<GirviListScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: GirviAppBar(
        screenTitle:    GirviStrings.listTitle,
        screenSubtitle: GirviStrings.listSub,
        ...
        actions: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: const Icon(GirviIcons.calculator,
                          ...
                          delegate: SliverChildBuilderDelegate(
                            (_, i) {
                              ...
                              return GirviTicketCard(
                                ...
                                onRelease: item.loan.isActive || item.loan.isOverdue
                                    ? () => _openRelease(item)
                                    : null,
                              );
                            },
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              _StatusPill('Released',  s.totalReleased,  GirviColors.statusReleased),
              _StatusPill('Auctioned', s.totalAuctioned, GirviColors.statusAuctioned),
            ],
          ),
...
class _ErrorState extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Center(
    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      ...
      Text(message, style: GirviStyles.caption.copyWith(fontSize: 14),
