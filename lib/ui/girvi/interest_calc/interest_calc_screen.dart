...
//               - App Bar extracted to interest_calc_app_bar.dart
// =============================================================================
...
import 'interest_calc_app_bar.dart'; // NAYA IMPORT
...
class _InterestCalcScreenState extends State<InterestCalcScreen>
  ...
  void initState() {
    ...
    _principalCtrl
        .addListener(() => _ctrl.onPrincipalChanged(_principalCtrl.text));
      ...
      child: Column(children: [
        ...
        SizedBox(
          ...
          child: rows.length > 6
              ...
              : Column(
                  children: rows
                      .map((r) => _buildTableRow(r, rows.indexOf(r)))
                      .toList(),
                ),
        ),
      ]),
