// =============================================================================
// FILE        : new_girvi_app_bar.dart
// MODULE      : Girvi / Pawn
// LAYER       : UI / Component
// DESCRIPTION : Premium Dark shell AppBar for the New Girvi Ticket screen.
...
class NewGirviAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  @override
  State<NewGirviAppBar> createState() => _NewGirviAppBarState();
}

class _NewGirviAppBarState extends State<NewGirviAppBar>
        ...
        child: Row(
          ...
          children: [
            ...
            Container(
              ...
              child: const Icon(
                GirviIcons.ticket, // Ticket icon specific to New Girvi
