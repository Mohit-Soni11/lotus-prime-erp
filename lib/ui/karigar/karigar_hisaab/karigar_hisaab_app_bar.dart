// =============================================================================
// FILE        : karigar_hisaab_app_bar.dart
// MODULE      : Karigar
// LAYER       : UI / Component
// DESCRIPTION : Premium Dark shell AppBar for the Karigar Hisaab screen.
...
class KarigarHisaabAppBar extends StatefulWidget
    implements PreferredSizeWidget {
  final VoidCallback onBack;

  const KarigarHisaabAppBar({
    super.key,
  ...
  @override
  State<KarigarHisaabAppBar> createState() => _KarigarHisaabAppBarState();
}

class _KarigarHisaabAppBarState extends State<KarigarHisaabAppBar>
        ...
        child: Row(
          ...
          children: [
            ...
            Container(
              ...
              child: const Icon(
                KarigarIcons.ledger, // Ledger icon for Hisaab
            ...
            Text(
              KarigarStrings.hisaabScreenTitle.toUpperCase(),
