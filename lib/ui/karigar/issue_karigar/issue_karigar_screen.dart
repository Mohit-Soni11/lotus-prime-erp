...
//               - Dark shell AppBar with radar SYSTEM ONLINE badge
//               - Gold dot + screen title + module badge (right)
...
//               Sections:
//               1. Select Karigar   2. Issue Details   3. Metal Details
//               4. Delivery Timeline   5. Notes
// =============================================================================
...
class _IssueKarigarScreenState extends State<IssueKarigarScreen>
  ...
  void dispose() {
    _ctrl.dispose();
    _masterCtrl.dispose();
    for (final c in [_descCtrl, _grossWtCtrl, _stoneWtCtrl, _qtyCtrl, _notesCtrl]) {
      c.dispose();
    }
  ...
  Future<void> _onSave() async {
    ...
    if (ok && mounted) {
      _showSuccessSnackbar(_ctrl.successMessage ?? KarigarStrings.successIssueSaved);
      _resetAll();
    }
  }
  ...
  Future<void> _pickDate({required bool isIssueDate}) async {
    final initial = isIssueDate ? _issueDate : (_expectedDelivery ?? DateTime.now().add(const Duration(days: 7)));
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: KarigarAppBar(
          screenTitle: KarigarStrings.issueScreenTitle,
          screenSubtitle: KarigarStrings.issueScreenSub,
      ...
      children: [
        ...
        KarigarRowTwo(
          left: KarigarDropdown<KarigarItemCategory>(
            ...
            itemLabel: (e) => e.label,
            onChanged: (v) { if (v != null) _ctrl.setItemCategory(v); },
          ),
  ...
  Widget _buildMetalSection() {
    ...
    return Column(
      ...
      children: [
        ...
        KarigarRowTwo(
          ...
          right: hasPurity
              ? KarigarDropdown<String>(
                  ...
                  itemLabel: (e) => e,
                  onChanged: (v) { if (v != null) _ctrl.setPurity(v); },
                )
        ...
        Row(children: [
          Expanded(child: KarigarInputField(
    ...
    return Column(
      ...
      children: [
        ...
        KarigarDropdown<IssueStatus>(
          ...
          itemLabel: (e) => e.label,
          onChanged: (v) { if (v != null) _ctrl.setStatus(v); },
        ),
      ],
    );
  }
    ...
    return Row(children: [
      ...
      Expanded(
        child: ElevatedButton.icon(
          ...
          label: Text(
            _ctrl.isSaving ? KarigarStrings.btnSaving : KarigarStrings.btnSaveIssue,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: KarigarColors.brandGold.withOpacity(0.35), width: 1.5),
      ),
      child: Row(children: [
        CircleAvatar(
        ...
        Expanded(child: Column(
          ...
          children: [
            ...
            Row(children: [
              Icon(KarigarIcons.phone, size: 11, color: KarigarColors.textMuted),
              const SizedBox(width: 4),
              Text(karigar.phone, style: KarigarStyles.caption),
              const SizedBox(width: 12),
              Icon(KarigarIcons.speciality, size: 11, color: KarigarColors.textMuted),
              const SizedBox(width: 4),
        ...
        IconButton(
          onPressed: onClear,
          icon: const Icon(KarigarIcons.close, color: KarigarColors.textMuted, size: 18),
...
class _KarigarPickerButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(children: [
      ...
      OutlinedButton.icon(
        onPressed: onAddNew,
        icon:  const Icon(KarigarIcons.addKarigar, size: 18, color: KarigarColors.info),
...
class _KarigarPickerSheet extends StatelessWidget {
  final KarigarMasterController masterCtrl;
  final Function(KarigarMaster) onSelected;
  const _KarigarPickerSheet({required this.masterCtrl, required this.onSelected});
        ...
        Padding(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: const Icon(KarigarIcons.search, color: KarigarColors.textHint, size: 20),
              filled: true,
      ...
      children: [
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: Row(children: [
              const Icon(KarigarIcons.calendar, color: KarigarColors.brandGold, size: 18),
              const SizedBox(width: 10),
              Container(width: 1, height: 22, color: KarigarColors.cardBorder),
              const SizedBox(width: 10),
              Expanded(
                child: Text(value, style: isOptional && value.startsWith('Select')
