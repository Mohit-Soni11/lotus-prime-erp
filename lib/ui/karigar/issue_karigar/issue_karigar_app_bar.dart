// =============================================================================
// FILE        : issue_karigar_app_bar.dart
// MODULE      : Karigar
// LAYER       : UI / Component
// DESCRIPTION : Premium Dark shell AppBar for the Issue Karigar screen.
...
class IssueKarigarAppBar extends StatefulWidget implements PreferredSizeWidget {
  final VoidCallback onBack;

  const IssueKarigarAppBar({
    super.key,
  ...
  @override
  State<IssueKarigarAppBar> createState() => _IssueKarigarAppBarState();
}

class _IssueKarigarAppBarState extends State<IssueKarigarAppBar>
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: const BoxDecoration(
        ...
        border: Border(
          bottom: BorderSide(color: KarigarColors.shellBorder, width: 1.0),
        ),
        boxShadow: [
          BoxShadow(
      ...
      child: SafeArea(
        ...
        child: Row(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: const LinearGradient(
                  ...
                  colors: [
                    KarigarColors.goldGradientStart, // Strictly from Theme
                ...
                boxShadow: [
                  BoxShadow(
                    color: KarigarColors.brandGold.withValues(alpha: 0.5),
                    blurRadius: 10,
              ...
              child: const Icon(
                KarigarIcons.moduleIcon,
                color: KarigarColors.cardBg, // White equivalent in theme
                size: 18,
              ),
            ),
            ...
            Text(
              KarigarStrings.issueScreenTitle,
              style: KarigarStyles.shellTitle.copyWith(
                fontSize: 18,
                letterSpacing: 1.2,
              ),
            ),
      ...
      child: GestureDetector(
        ...
        child: AnimatedScale(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: _isHovered
                  ? KarigarColors.shellBg
                  : KarigarColors.shellBorder.withValues(alpha: 0.3),
              borderRadius: BorderRadius.circular(10),
              border: Border.all(
                color: _isHovered
                    ? KarigarColors.brandGold
              ...
              boxShadow: _isHovered
                  ? [
                      BoxShadow(
                        color: KarigarColors.brandGold.withValues(alpha: 0.3),
                        blurRadius: 12,
                        offset: const Offset(0, 3),
                      ),
                    ]
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: KarigarColors.onlineGreen.withValues(alpha: 0.3),
        ),
      ),
      child: Row(
