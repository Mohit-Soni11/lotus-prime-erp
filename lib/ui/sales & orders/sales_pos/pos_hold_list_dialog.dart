...
// TYPE: Smart UI Component (Dialog) — PREMIUM UPGRADE
// DESCRIPTION: Premium Parked Invoice Browser with animated cards.
//              ✅ THEME INVERSION FIXED (Text is now clearly visible on cards)
...
class _PosHoldListDialogState extends State<PosHoldListDialog>
  ...
  Future<void> _confirmAndDelete(BuildContext context, PosHoldBillModel hold) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: const Text("Discard Invoice?",
            style: TextStyle(color: SalesPosColors.shellTextTitle, fontSize: 18, fontWeight: FontWeight.w900)),
        content: Text(
          "This will permanently discard the parked invoice for "
          "${hold.customerName.isEmpty ? 'Walk-in Customer' : hold.customerName}.",
          style: const TextStyle(color: SalesPosColors.shellTextTitle, fontSize: 15, fontWeight: FontWeight.w600, height: 1.4), 
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(ctx, false),
            child: const Text("Cancel", style: TextStyle(color: SalesPosColors.shellTextMuted, fontWeight: FontWeight.w700, fontSize: 14)),
          ),
          ElevatedButton(
            ...
            child: const Text("Discard", style: TextStyle(fontWeight: FontWeight.w800, fontSize: 14)),
          ),
        ],
      ),
    );
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                SalesPosColors.brandGold.withOpacity(0.08),
                Colors.transparent,
              ],
            ),
          ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: const TextStyle(color: SalesPosColors.shellTextMuted, fontSize: 13, fontWeight: FontWeight.w600), 
                    ),
                  ],
                ),
              ),
              ...
              if (widget.ctrl.heldBills.isNotEmpty)
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    style: const TextStyle(color: Colors.black, fontWeight: FontWeight.w900, fontSize: 15, height: 1.0), // height 1.0 ensures vertical centering
                  ),
                ),

              IconButton(
                icon: const Icon(Icons.close_rounded, color: SalesPosColors.shellTextMuted, size: 24), 
                onPressed: () => Navigator.pop(context),
                style: IconButton.styleFrom(
                  backgroundColor: SalesPosColors.bodyBorder.withOpacity(0.3),
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            height: 76,
            decoration: BoxDecoration(
              color: SalesPosColors.brandGold.withOpacity(0.08),
              shape: BoxShape.circle,
              border: Border.all(color: SalesPosColors.brandGold.withOpacity(0.20), width: 1.5),
            ),
            child: const Icon(Icons.inbox_outlined, color: SalesPosColors.brandGold, size: 36),
          ),
          ...
          const Text(
            ...
            style: TextStyle(color: SalesPosColors.shellTextMuted, fontSize: 14, fontWeight: FontWeight.w600, height: 1.6), 
          ),
          ...
          OutlinedButton(
            ...
            style: OutlinedButton.styleFrom(
              ...
              side: const BorderSide(color: SalesPosColors.brandGold, width: 2.0), 
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
              padding: const EdgeInsets.symmetric(horizontal: 28, vertical: 16),
            ),
            child: const Text("Back to Billing", style: TextStyle(fontWeight: FontWeight.w900, fontSize: 14)), 
          ),
        ],
      ),
    );
...
class _AnimatedHoldCardState extends State<_AnimatedHoldCard>
  ...
  Widget _buildCard() {
    ...
    final String displayName = hold.customerName.isEmpty ? "Walk-in Customer" : hold.customerName;
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: _isHovered ? SalesPosColors.brandGold.withOpacity(0.5) : SalesPosColors.bodyBorder, 
          width: 1.5 
        ),
        boxShadow: [
          BoxShadow(
            color: _isHovered ? SalesPosColors.brandGold.withOpacity(0.1) : Colors.black.withOpacity(0.10),
                      ...
                      Row(
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: isWalkIn
                                  ? SalesPosColors.bodyTextMuted.withOpacity(0.12) // FIX 3: Changed to bodyTextMuted
                            ...
                            child: Center(
                              child: Text(
                                ...
                                style: TextStyle(
                                  color: isWalkIn ? SalesPosColors.bodyTextMain : SalesPosColors.brandGold, // FIX 3: Changed to bodyTextMain
                                  fontWeight: FontWeight.w900,
                                  fontSize: 16, 
                                ),
                              ),
                              ...
                              children: [
                                Text(
                                  ...
                                  style: const TextStyle(
                                    color: SalesPosColors.bodyTextMain, // FIX 3: Bright Dark Title Color
                                    fontWeight: FontWeight.w900, 
                                    fontSize: 16, 
                                  ),
                                ),
                      ...
                      Row(
                        children: [
                          ...
                          _buildStatPill(
                            ...
                            label: "${hold.totalItems} item${hold.totalItems == 1 ? '' : 's'}",
                          ...
                          _buildStatPill(
                            ...
                            bgColor: SalesPosColors.success.withOpacity(0.10),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [
            SalesPosColors.brandGold.withOpacity(0.18),
            SalesPosColors.brandGold.withOpacity(0.07),
          ],
        ),
        border: const Border(right: BorderSide(color: SalesPosColors.bodyBorder, width: 1.5)),
      ),
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          const Icon(Icons.access_time_rounded, color: SalesPosColors.brandGold, size: 18),
          const SizedBox(height: 6),
          Text(
            time,
            textAlign: TextAlign.center,
            style: const TextStyle(color: SalesPosColors.brandGold, fontSize: 12, fontWeight: FontWeight.w900, height: 1.3), 
          ),
          const SizedBox(height: 3),
          // FIX 2: Date is now bold and dark
          Text(date, style: const TextStyle(color: SalesPosColors.bodyTextMain, fontSize: 11.5, fontWeight: FontWeight.w800)), 
        ],
      ),
    );
  }
  ...
  Widget _buildStatPill({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: SalesPosColors.bodyBorder.withOpacity(0.6)),
      ),
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          ...
          Text(label, style: TextStyle(fontSize: 13, color: textColor, fontWeight: FontWeight.w800)), 
        ],
      ),
    );
  }
      ...
      children: [
        Padding(
          ...
          child: ElevatedButton.icon(
            ...
            label: const Text("RESUME", style: TextStyle(fontSize: 12, fontWeight: FontWeight.w900, letterSpacing: 0.8)), 
        ...
        Padding(
          ...
          child: OutlinedButton.icon(
            style: OutlinedButton.styleFrom(
              ...
              side: BorderSide(color: SalesPosColors.danger.withOpacity(0.70), width: 1.5), 
              padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 10),
              minimumSize: Size.zero,
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
            ),
            icon: const Icon(Icons.delete_outline_rounded, size: 16),
            label: const Text("DISCARD", style: TextStyle(fontSize: 12, fontWeight: FontWeight.w800, letterSpacing: 0.8)), 
