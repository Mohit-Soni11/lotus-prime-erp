      ...
      builder: (context, snapshot) {
        ...
        return Container(
          ...
          child: ClipRRect(
            ...
            child: Stack(
              children: [
                // ðŸ”¥ PERFORMANCE FIX: RepaintBoundary prevents background redraws
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ShaderMask(
                            shaderCallback: (bounds) => BillCardColors
                                .goldTextGradient
                                .createShader(bounds),
                            child: const Text(
                      ...
                      isLoading
                          ...
                          : AnimatedSwitcher(
                              ...
                              switchInCurve:
                                  Curves.elasticOut, // Thoda bounce effect
                      ...
                      Row(
                        children: [
                          ...
                          const Text(BillCardStrings.subTitlePrefix,
                              style: BillCardStyles.subLabelStyle),
      ...
      child: Center(
        child: ShaderMask(
          shaderCallback: (bounds) => const LinearGradient(colors: [
            BillCardColors.accentGoldBright,
            BillCardColors.accentGold
          ]).createShader(bounds),
          child: const Icon(BillCardIcons.billIcon,
              color: Colors.white, size: BillCardStyles.iconSize),
        ),
      ),
    );
  }
      ...
      children: [
        ...
        Positioned(
          ...
          child: Container(
              ...
              decoration: const BoxDecoration(
                  shape: BoxShape.circle,
                  color: BillCardColors.glowBottomLeft,
                  boxShadow: [
                    BoxShadow(
                        color: BillCardColors.glowBottomLeft,
                        blurRadius: 60,
