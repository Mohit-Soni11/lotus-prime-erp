...
// DESCRIPTION : Right panel â€” same structure as PosRightBillingPanel.
...
class BookingRightPanel extends StatefulWidget {
  ...
  const BookingRightPanel(
      {super.key, required this.ctrl, required this.onSaved});
...
class _BookingRightPanelState extends State<BookingRightPanel> {
  ...
  // â”€â”€ BOOKING SUMMARY BOARD â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  Widget _buildSummaryBoard() {
    ...
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        // Customer
        _row('Customer',
            ctrl.nameCtrl.text.isNotEmpty ? ctrl.nameCtrl.text : 'â€”',
            valueColor: ctrl.nameCtrl.text.isNotEmpty
        ...
        if (isLocked && ctrl.lockedRate > 0)
          _row(
              'Locked Rate', 'â‚¹ ${fmt.format(ctrl.lockedRate.toInt())} / 10g',
              valueColor: BookingAdvanceColors.lockedRateColor),

        // Delivery date
        if (ctrl.deliveryDate != null)
          _row('Delivery Date',
              DateFormat('dd MMM yyyy').format(ctrl.deliveryDate!)),
        ...
        Container(
          ...
          child:
            ...
            const Text('APPROX. BOOKING VALUE',
                style: BookingAdvanceStyles.totalRowLabel),
            Text('â‚¹ ${fmt.format(ctrl.totalBookingVal.toInt())}',
                style: BookingAdvanceStyles.totalRowValue),
          ]),
        ),
                ...
                children: [
                  const Row(children: [
                    Icon(Icons.recycling_rounded,
                        color: BookingAdvanceColors.danger, size: 16),
                    SizedBox(width: 8),
                    Text('SCRAP METAL VALUE',
                        style: TextStyle(
                            fontSize: 13,
                  ...
                  Text('â‚¹ ${fmt.format(ctrl.totalScrapVal.toInt())}',
  ...
  // â”€â”€ ADVANCE PAYMENT HUB â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  Widget _buildPaymentHub() {
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        // Cash
        _payRow(BookingAdvanceStrings.lblCash, BookingAdvanceIcons.cash,
            BookingAdvanceColors.cashColor, ctrl.cashCtrl),
        const SizedBox(height: 10),
        // UPI
        _payRow(BookingAdvanceStrings.lblUpi, BookingAdvanceIcons.upi,
            BookingAdvanceColors.upiColor, ctrl.upiCtrl),
        const SizedBox(height: 10),
        // Card
        _payRow(BookingAdvanceStrings.lblCard, BookingAdvanceIcons.card,
            BookingAdvanceColors.cardColor, ctrl.cardCtrl),
        ...
        Container(
          ...
          child:
            ...
            Text(
                'â‚¹  ${NumberFormat('#,##,###').format(ctrl.totalAdvance.toInt())}',
        ...
        if (ctrl.totalBookingVal > 0) ...[
          ...
          Container(
            padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 12),
            decoration: BoxDecoration(
              color: ctrl.balanceDue > 0
                  ? BookingAdvanceColors.warning.withValues(alpha: 0.06)
                  : BookingAdvanceColors.success.withValues(alpha: 0.06),
              borderRadius: BorderRadius.circular(10),
              border: Border.all(
                  color: ctrl.balanceDue > 0
                      ? BookingAdvanceColors.warning.withValues(alpha: 0.3)
                      : BookingAdvanceColors.success.withValues(alpha: 0.3)),
            ),
            child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  ...
                  Text(
                      'â‚¹ ${NumberFormat('#,##,###').format(ctrl.balanceDue.abs().toInt())}',
                      style: TextStyle(
                          fontSize: 15,
                          fontWeight: FontWeight.w900,
                          color: ctrl.balanceDue > 0
  ...
  Widget _payRow(
      String label, IconData icon, Color color, TextEditingController payCtrl) {
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        ...
        Flexible(
            child: Text(val,
                ...
                style: BookingAdvanceStyles.summaryValue
...
class _HoverOutlineBtn extends StatefulWidget {
  ...
  const _HoverOutlineBtn(
      {required this.label, required this.icon, required this.onTap});
  @override
  State<_HoverOutlineBtn> createState() => _HoverOutlineBtnState();
}
