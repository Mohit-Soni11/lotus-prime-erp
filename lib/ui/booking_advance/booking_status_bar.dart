...
// DESCRIPTION : Booking Number bar — same layout as PosInvoiceStatusBar.
// =============================================================================
...
class _BookingStatusBarState extends State<BookingStatusBar>
  ...
  Widget _buildCard() {
    ...
    final accent   = isLocked ? BookingAdvanceColors.lockedRateColor : BookingAdvanceColors.brandGold;
            ...
            Row(
              ...
              children: [
                Row(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                    const Text(BookingAdvanceStrings.sectionBookingNo, style: BookingAdvanceStyles.highVisHeader),
                    const SizedBox(height: 4),
                    AnimatedDefaultTextStyle(
                      duration: const Duration(milliseconds: 260),
                      style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold,
                        color: isLocked ? BookingAdvanceColors.lockedRateColor : BookingAdvanceColors.bodyTextMuted),
                ...
                AnimatedContainer(
                  ...
                  child: Row(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    Text(BookingAdvanceStrings.bookingBadge,
                      style: TextStyle(fontSize: 11, fontWeight: FontWeight.w900, letterSpacing: 0.8, color: accent)),
                  ]),
                ),
              ],
            ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Stack(children: [
                      Positioned(top: 0, left: 8, right: 8,
                        child: Container(height: 1,
                          decoration: BoxDecoration(
                            gradient: LinearGradient(colors: [Colors.transparent, accent.withOpacity(0.55), Colors.transparent])))),
                      Center(child: Icon(BookingAdvanceIcons.moduleIcon, color: accent, size: 24)),
                    ]),
                  ),
                  ...
                  Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                    const Text(BookingAdvanceStrings.bookingNoLabel,
                      style: TextStyle(fontSize: 10, fontWeight: FontWeight.w900, letterSpacing: 1.4, color: BookingAdvanceColors.textDark, height: 1)),
                    const SizedBox(height: 4),
                    Text(widget.ctrl.formattedBookingNo,
                      style: TextStyle(color: accent, fontSize: 20, fontWeight: FontWeight.w900, letterSpacing: 1.5, height: 1)),
                  ]),
                  ...
                  Container(width: 1, height: 34,
                    decoration: const BoxDecoration(gradient: LinearGradient(begin: Alignment.topCenter, end: Alignment.bottomCenter,
                      colors: [Colors.transparent, BookingAdvanceColors.bodyBorder, Colors.transparent]))),
                  ...
                  StreamBuilder<DateCardModel>(
                    ...
                    builder: (_, snap) {
                      ...
                      return Row(mainAxisSize: MainAxisSize.min, children: [
                        _chip(BookingAdvanceIcons.calendarDate, BookingAdvanceColors.textDark,
                            BookingAdvanceStrings.dateLabel, d.date.toUpperCase(), BookingAdvanceColors.textDark, 13,
                            BookingAdvanceColors.bodyBg, BookingAdvanceColors.bodyBorder),
                        const SizedBox(width: 8),
                        Container(width: 4, height: 4, decoration: const BoxDecoration(color: BookingAdvanceColors.bodyTextMuted, shape: BoxShape.circle)),
                        const SizedBox(width: 8),
                        _chip(BookingAdvanceIcons.clockTime, BookingAdvanceColors.success,
                            BookingAdvanceStrings.timeLabel, t, BookingAdvanceColors.success, 14,
                            BookingAdvanceColors.success.withOpacity(0.07), BookingAdvanceColors.success.withOpacity(0.25)),
                      ]);
                    },
                  ),
                ],
  ...
  Widget _chip(IconData icon, Color ic, String sub, String val, Color vc, double vfs, Color bg, Color border) {
    return Container(
      height: 44, padding: const EdgeInsets.symmetric(horizontal: 14),
      decoration: BoxDecoration(color: bg, borderRadius: BorderRadius.circular(10), border: Border.all(color: border)),
      child: Row(mainAxisSize: MainAxisSize.min, children: [
        Container(width: 26, height: 26, decoration: BoxDecoration(color: ic.withOpacity(0.12), borderRadius: BorderRadius.circular(7)),
          child: Icon(icon, color: ic, size: 14)),
        const SizedBox(width: 10),
        Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(sub, style: TextStyle(color: ic.withOpacity(0.8), fontSize: 9, fontWeight: FontWeight.w900, letterSpacing: 1.0)),
          const SizedBox(height: 2),
          Text(val, style: TextStyle(color: vc, fontSize: vfs, fontWeight: FontWeight.w900, letterSpacing: 0.3, height: 1)),
        ]),
      ]),
    );
  }
