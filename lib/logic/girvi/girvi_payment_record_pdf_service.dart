...
part 'girvi_payment_record_pdf_helpers.dart';
...
class GirviPaymentRecordPdfService {
  ...
  Future<Uint8List> build({
    ...
    final photos = loadPaymentRecordItemPhotos(account, details);
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        footer: (context) => buildPaymentRecordFooter(context, branding),
        build: (_) {
          ...
          if (photos.isNotEmpty) {
            widgets
              ...
              ..add(buildPaymentRecordPhotoSection(photos));
          }
          ...
          widgets
            ...
            ..add(pw.SizedBox(height: 8))
            ..add(buildPaymentRecordSignatureBlock());
                ...
                pw.Expanded(
                  child: pw.Column(
                    ...
                    children: [
                      ...
                      for (final line in branding.printHeaderLines.take(4))
  ...
  pw.Widget _buildPledgedItemsTable(
    ...
    final rows = buildPledgedPaymentRecordRows(account, details);
