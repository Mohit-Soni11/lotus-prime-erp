// =============================================================================
// FILE        : silver_invoice_logic.dart
// MODULE      : Stock & Inventory — Silver
// LAYER       : Logic / Invoice
// DESCRIPTION : Isolated Invoice Logic for Silver Add Stock.
...
//
// USAGE:
//   final invoice = SilverInvoiceLogic();
//   invoice.init();
...
// ─────────────────────────────────────────────────────────────────────────────
class SilverInvoiceLogic {
  // ── DATE / TIME STREAM ───────────────────────────────────────
  /// Live date+time stream — used by SilverInvoiceCard for chips display.
  ...
  /// stateless about GST (GST state lives in SilverOverviewLogic).
  ...
  /// Generates a unique system batch ID for this silver intake session.
  ///
  /// Format: SIL-YYYYMMDD-XXXX
  ///   SIL   — Silver module prefix (3 chars, fixed)
