// =============================================================================
// FILE        : silver_row_entry.dart
// MODULE      : Stock & Inventory — Silver
// LAYER       : Logic / Data Model
// DESCRIPTION : Isolated data model for a single Silver stock entry row.
//               ✅ 100% Silver-specific — no Gold touch/fine-weight fields.
//               ✅ Pure Dart class — no Flutter dependency.
//               ✅ Future-proof: extend with silver-specific fields freely
...
//   Silver needs purchaseRate per gram, NO karat math, higher qty tolerance.
...
// ─────────────────────────────────────────────────────────────────────────────
// SILVER ROW ENTRY
// One row in the silver stock intake table.
// ─────────────────────────────────────────────────────────────────────────────
class SilverRowEntry {
  ...
  // ── COMPLIANCE ───────────────────────────────────────────────
  /// HUID is optional for silver but field is present for future BIS compliance.
  String huid = '';
  String hsnCode;
