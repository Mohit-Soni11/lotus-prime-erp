...
class TaxGstConfigs extends Table {
  ...
  TextColumn get taxpayerType     => text().withDefault(const Constant('Regular'))();
  ...
  BoolColumn get taxInclusivePricing   => boolean().withDefault(const Constant(false))();
  BoolColumn get roundOffGstAmount     => boolean().withDefault(const Constant(true))();
  BoolColumn get showGstBreakupOnBill  => boolean().withDefault(const Constant(true))();
  BoolColumn get compositeSupplyMode   => boolean().withDefault(const Constant(false))();
  ...
  BoolColumn  get eInvoicingEnabled     => boolean().withDefault(const Constant(false))();
  TextColumn  get eInvoiceTurnoverLimit => text().withDefault(const Constant('₹5 Crore'))();
  TextColumn  get irpApiUsername        => text().nullable()();
  TextColumn  get irpApiPassword        => text().nullable()();
  BoolColumn  get gstr1FilingReminder   => boolean().withDefault(const Constant(true))();
  BoolColumn  get gstr3bFilingReminder  => boolean().withDefault(const Constant(true))();
