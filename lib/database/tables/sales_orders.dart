...
@TableIndex(name: 'idx_orders_status', columns: {#status}) // Pending orders filter karne ke liye
...
@TableIndex(name: 'idx_advances_order', columns: {#orderId}) // Fast retrieval of payments
