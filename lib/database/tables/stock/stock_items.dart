...
class StockItems extends Table with BaseTable {
  ...
  // ── 6. PRICING ─────────────────────────────────────────────────────────
  RealColumn get makingCharge =>
      real().withDefault(const Constant(0.0))(); // ✅ Fixed Name
  TextColumn get makingChargeType =>
      text().withDefault(const Constant('Per Gram (Rs/g)'))(); // ✅ Fixed Name
  ...
  TextColumn get location => text().nullable()(); // ✅ Fixed Name
