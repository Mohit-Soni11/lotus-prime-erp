...
import '../stock_enums/stock_enums.dart';
...
class StockItemModel {
  ...
  StockItemModel copyWith({
    String? sku, String? itemName, String? description,
    StockCategory? category, StockSubCategory? subCategory,
    MetalType? metalType, String? purity,
    double? grossWeight, double? stoneWeight, double? netWeight,
    StoneType? stoneType, double? stoneCarats, int? stonePieces,
    double? makingCharges, MakingChargesType? makingChargesType,
    double? purchasePrice, double? mrp,
    String? hsnCode, String? huid, double? gstRate,
    int? quantity, String? rackLocation, String? supplierName,
    StockStatus? status, String? imagePath,
  }) => StockItemModel(
    sku:               sku              ?? this.sku,
