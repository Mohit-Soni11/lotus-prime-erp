...
extension SecurityMetalExt on SecurityMetal {
  String get label {
    switch (this) {
      case SecurityMetal.gold:     return 'GOLD';
      case SecurityMetal.silver:   return 'SILVER';
      case SecurityMetal.platinum: return 'PLATINUM';
      case SecurityMetal.diamond:  return 'DIAMOND';
    }
  }

  String get emoji {
    switch (this) {
      case SecurityMetal.gold:     return '🥇';
      case SecurityMetal.silver:   return '🥈';
      case SecurityMetal.platinum: return '💎';
      case SecurityMetal.diamond:  return '💍';
    }
  }
}
