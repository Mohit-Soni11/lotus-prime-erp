...
class AddCustomerFormModel {
  ...
  bool get hasErrors =>
      firstNameError != null || mobileError != null ||
      panError != null || emailError != null;
  ...
  AddCustomerFormModel copyWith({
    ...
    DateTime? dateOfBirth,     bool clearDob           = false,
    Gender? gender,            bool clearGender        = false,
    DateTime? anniversaryDate, bool clearAnniversary   = false,
    String? mobile,
    bool? sameAsWhatsApp,
    String? whatsapp,
    String? email,
    ...
    String? panNumber,
    IdProofType? idProofType,  bool clearIdProofType   = false,
    String? idProofNumber,
    String? idProofDocPath,    bool clearIdProofDocPath= false,
    String? gstNumber,
    String? addressLine1,
    String? addressLine2,
    String? country,
    ...
    String? membershipId,
    RingSize? ringSize,        bool clearRingSize      = false,
    BangleSize? bangleSize,    bool clearBangleSize    = false,
    List<FamilyMember>? familyMembers,
    ReferralSource? referralSource, bool clearReferralSource = false,
    String? notes,
    String? profileImagePath,  bool clearProfileImage  = false,
    String? firstNameError,    bool clearFirstNameError= false,
    String? mobileError,       bool clearMobileError   = false,
    String? panError,          bool clearPanError      = false,
    String? emailError,        bool clearEmailError    = false,
    ...
    return AddCustomerFormModel(
      ...
      anniversaryDate:  clearAnniversary   ? null : (anniversaryDate  ?? this.anniversaryDate),
      ...
      idProofDocPath:   clearIdProofDocPath? null : (idProofDocPath    ?? this.idProofDocPath),
      ...
      referralSource:   clearReferralSource? null : (referralSource    ?? this.referralSource),
