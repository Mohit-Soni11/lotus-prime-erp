...
//              ✅ Extracted UI hardcoded text styles integrated.
// ==========================================
...
class SalesPosStyles {
  ...
  // --- 🚀 NEW: EXTRACTED SEMANTIC UI STYLES ---
  ...
  static TextStyle subTitleMuted = TextStyle(
    ...
    color: SalesPosColors.bodyTextMuted.withOpacity(0.70),
  );

  // Big Numbers & Grand Totals (e.g. ₹ 50,000.00 in Right Panel)
