...
class SalesPosColors {
  ...
  static const Color upiButtonBg = Color(0xFF00796B); // Extracted from UPI Return Button
  ...
  static const Color badgeDeepShadow = Color(0xFF111520); // 🚀 NEW: Extracted from Login Badge depth
  ...
  static const Color formInputBg = Color(0xFFFAFAFA); // Extracted from Input TextFields
