...
class GirviStyles {
  ...
  static TextStyle get shellTitle => GoogleFonts.inter(
    ...
    color: GirviColors.shellTextTitle, letterSpacing: 0.8,
  );

  static TextStyle get shellMuted => GoogleFonts.inter(
    fontSize: 11, fontWeight: FontWeight.w400,
    color: GirviColors.shellTextMuted, letterSpacing: 0.3,
  );

  static TextStyle get sectionTitle => GoogleFonts.manrope(
    fontSize: 14, fontWeight: FontWeight.w700,
    color: GirviColors.textDark, letterSpacing: 0.2,
  );

  static TextStyle get fieldLabel => GoogleFonts.inter(
    fontSize: 12, fontWeight: FontWeight.w600,
    color: GirviColors.textBody, letterSpacing: 0.1,
  );

  static TextStyle get fieldInput => GoogleFonts.manrope(
    fontSize: 14, fontWeight: FontWeight.w700, color: GirviColors.textDark,
  );

  static TextStyle get fieldHint => GoogleFonts.inter(
    fontSize: 13, fontWeight: FontWeight.w400, color: GirviColors.textHint,
  );

  static TextStyle get readOnlyValue => GoogleFonts.manrope(
    fontSize: 15, fontWeight: FontWeight.w800, color: GirviColors.success,
  );

  static TextStyle get readOnlyLabel => GoogleFonts.inter(
    fontSize: 11, fontWeight: FontWeight.w400, color: GirviColors.textMuted,
  );

  static TextStyle get ticketNumber => GoogleFonts.robotoMono(
    fontSize: 14, fontWeight: FontWeight.w700,
    color: GirviColors.brandGold, letterSpacing: 1.0,
  );

  static TextStyle get saveButtonText => GoogleFonts.manrope(
    fontSize: 15, fontWeight: FontWeight.w800,
    color: GirviColors.shellBg, letterSpacing: 0.3,
  );
  ...
  static TextStyle get amountLarge => GoogleFonts.manrope(
    fontSize: 22, fontWeight: FontWeight.w900, color: GirviColors.textDark,
  );
  ...
  static BoxDecoration get inputFocused => BoxDecoration(
    ...
    boxShadow: [BoxShadow(
      color: GirviColors.brandGold.withOpacity(0.12),
      blurRadius: 8,
    )],
  );
  ...
  static BoxDecoration statCardDecoration(Color accent) => BoxDecoration(
    ...
    boxShadow: const [
      BoxShadow(color: GirviColors.shadowLight, blurRadius: 6, offset: Offset(0, 2)),
    ],
  );
}