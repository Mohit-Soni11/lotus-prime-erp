...
class LayoutStyles {
  ...
  static BoxDecoration glassPanelDecoration = BoxDecoration(
    color: LayoutColors.panelBg.withOpacity(0.95), // Deep Navy opacity
    border: const Border(
  ...
  static InputDecoration inputDecoration({
    ...
    return InputDecoration(
      filled: true,
      // ✅ Updated: Uses 'inputFill' from new LayoutColors
      fillColor: LayoutColors.inputFill, 
      hintText: hint,
      // ✅ Updated: Uses 'textPlaceholder'
      hintStyle: GoogleFonts.inter(color: LayoutColors.textPlaceholder, fontSize: 13),
      ...
      enabledBorder: OutlineInputBorder(
        ...
        borderSide: const BorderSide(color: LayoutColors.borderStroke, width: 1),
      ),

      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(10),
        // ✅ Updated: Focus par Royal Gold Border
        borderSide: const BorderSide(color: LayoutColors.goldPrimary, width: 1.5),
      ),
