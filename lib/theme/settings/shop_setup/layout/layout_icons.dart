...
class LayoutIcons {
  ...
  static const IconData tax = Icons.receipt_long_rounded;
  static const IconData bank = Icons.account_balance_rounded;
  static const IconData brand = Icons.verified_user_rounded;

  // --- 🟢 Status ---
  static const IconData checkCircle = Icons.check_circle_rounded;
  static const IconData security = Icons.verified_user_outlined;
}