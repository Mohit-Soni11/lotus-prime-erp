...
class LayoutColors {
  // --- 🌌 DASHBOARD MATCHED BACKGROUNDS (Deep Navy) ---
  ...
  static const Color cardSurface = Color(0xFF252F3F); // Thoda sa aur light for cards
  
  // --- 🏆 ROYAL GOLD (Dashboard Accent) ---
  // Ye wahi 'accentGold' hai (0xFFD4AF37)
  static const Color goldPrimary = Color(0xFFD4AF37); 
  static const Color goldLight = Color(0xFFFFD700);   
  static const Color goldDark = Color(0xFFB8860B);
  
  // --- 🟢 SYSTEM STATUS (Dashboard Green) ---
  ...
  // --- 🌫️ BORDERS & DIVIDERS ---
  static const Color borderStroke = Color(0xFF374151); // Divider Color form Dashboard
