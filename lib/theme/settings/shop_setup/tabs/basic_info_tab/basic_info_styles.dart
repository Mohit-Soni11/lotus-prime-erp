...
class BasicInfoStyles {
  ...
  static const double szTitle20 = 20.0; // 🚀 UPGRADE: Extracted from UI Dialogs
  static const double szHeader18 = 18.0; // 🚀 UPGRADE: Extracted from UI Headers
  ...
  static const EdgeInsets padAll24 = EdgeInsets.all(24.0); // 🚀 UPGRADE: Extracted
  static const EdgeInsets padAll20 = EdgeInsets.all(20.0); // 🚀 UPGRADE: Extracted
  
  // Padding for small action buttons (Upload/Preview)
  static const EdgeInsets padActionBtn = EdgeInsets.symmetric(horizontal: 12, vertical: 8); 
  static const EdgeInsets padDialogOption = EdgeInsets.symmetric(horizontal: 16, vertical: 10); // 🚀 UPGRADE: Extracted
  ...
  static BoxDecoration activeInputDecoration = BoxDecoration(
    ...
    boxShadow: [
      BoxShadow(
        color: BasicInfoColors.goldAccent.withOpacity(0.15), // Golden Glow
        blurRadius: 8,
