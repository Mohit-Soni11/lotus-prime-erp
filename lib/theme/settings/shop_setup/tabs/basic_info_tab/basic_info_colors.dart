...
class BasicInfoColors {
  ...
  static const Color inputBgLocked = Color(0xFFF3F4F6); // Locked Field Background (Greyish)
  ...
  // --- Common Elements ---
  static const Color goldAccent = Color(0xFFD4AF37);   // Focus/Active State (Premium Gold)
  ...
  static const Color textHeaderSub = Color(0xFF4B5563); // 🚀 UPGRADE: Darker grey for Header visibility
  ...
  static const Color actionBlue = Colors.blueAccent;   // 🚀 UPGRADE: Extracted from UI
  
  static const Color statusActiveBg = Color(0xFFDCFCE7); // Verified Badge Bg
  static const Color statusActiveText = Color(0xFF166534); // Verified Badge Text
  
  static const Color borderWarning = Color(0xFFFCD34D); // Warning Border
  static const Color imgPlaceholderBg = Color(0xFFF3F4F6); // Image Upload Placeholder
