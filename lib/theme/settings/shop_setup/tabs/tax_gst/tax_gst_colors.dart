...
class TaxGstColors {
  ...
  static final Color overlayDark80 = overlayDark.withOpacity(0.8);
  static final Color overlayDark90 = overlayDark.withOpacity(0.9);
  static final Color overlayDark60 = cardBg.withOpacity(0.6); // For Loading Overlay
  static final Color overlayDark03 = overlayDark.withOpacity(0.03); // For Shadows
  ...
  static final Color goldAccent10 = goldAccent.withOpacity(0.1);
  static final Color goldAccent30 = goldAccent.withOpacity(0.3);
  static final Color goldAccent40 = goldAccent.withOpacity(0.4);
  ...
  static final Color statusActiveText30 = statusActiveText.withOpacity(0.3); // Extracted from UI Pill
