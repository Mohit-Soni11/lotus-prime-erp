...
abstract final class TaxGstStrings {
  ...
  static const String appBarSubtitle     = 'GST registration, rates, HSN codes & compliance';
  ...
  static const String card01Subtitle     = 'GSTIN, legal name, taxpayer type & registration details';
  ...
  static const String card01SectionSub   = 'Your official GST registration details printed on every invoice';

  // ── Card 02 — GST Slabs ──────────────────────────────────────
  static const String card02Title        = 'GST Slabs & Rates';
  static const String card02Subtitle     = 'Configure applicable GST rates per jewellery category';
  static const String card02Tag          = 'Gold 3% · Making 5% · Repair 18%';
  static const String card02SectionTitle = 'GST Rate Configuration';
  static const String card02SectionSub   = 'Category-wise GST rates — auto-applied during billing';

  // ── Card 03 — HSN Codes ──────────────────────────────────────
  static const String card03Title        = 'HSN Code Manager';
  static const String card03Subtitle     = 'Map HSN/SAC codes to your product categories';
  static const String card03Tag          = '71131910 · 71131120 · 99889900';
  static const String card03SectionTitle = 'HSN / SAC Code Mapping';
  static const String card03SectionSub   = 'Required for GST returns — maps to item categories on bill';

  // ── Card 04 — Tax Preferences ────────────────────────────────
  static const String card04Title        = 'Tax Computation';
  static const String card04Subtitle     = 'IGST auto-split, inclusive pricing & rounding rules';
  ...
  static const String card04SectionSub   = 'Controls how GST is calculated and displayed on bills';

  // ── Card 05 — TCS / TDS ──────────────────────────────────────
  static const String card05Title        = 'TCS & TDS';
  static const String card05Subtitle     = 'Section 206C TCS on jewellery sales above threshold';
  static const String card05Tag          = 'TCS 1% · ₹2L Threshold · Sec 206C';
  static const String card05SectionTitle = 'TCS & TDS Configuration';
  static const String card05SectionSub   = 'Auto-collect TCS on high-value jewellery transactions';

  // ── Card 06 — E-Invoice ──────────────────────────────────────
  static const String card06Title        = 'E-Invoice & Compliance';
  static const String card06Subtitle     = 'E-invoicing threshold, IRP API & filing reminders';
  static const String card06Tag          = 'IRN · QR Code · GSTR-1 · GSTR-3B';
  static const String card06SectionTitle = 'E-Invoice & GST Compliance';
  static const String card06SectionSub   = 'Configure IRP integration and automated filing reminders';

  // ── Card 07 — BIS Hallmarking ─────────────────────────────────
  static const String card07Title        = 'BIS & Hallmarking';
  static const String card07Subtitle     = 'BIS license number, HUID settings & validity tracker';
  ...
  static const String card07SectionSub   = 'Mandatory for hallmarked gold jewellery — printed on every bill';
  ...
  static const List<String> eInvoiceThresholds = [
    '₹5 Crore', '₹10 Crore', '₹20 Crore', '₹50 Crore',
  ];

  // ── Toggle Labels ─────────────────────────────────────────────
  static const String toggleAutoSplitTitle   = 'Auto-split IGST → CGST + SGST';
  static const String toggleAutoSplitSub     = 'Automatically applies for intra-state transactions';
  static const String toggleTaxInclusiveTitle = 'Tax-Inclusive Pricing';
  static const String toggleTaxInclusiveSub  = 'Item prices on bill include GST (MRP pricing model)';
  static const String toggleRoundOffTitle    = 'Round-off GST Amount';
  static const String toggleRoundOffSub      = 'Round total GST to nearest rupee on invoice';
  static const String toggleShowOnBillTitle  = 'Show GST Breakup on Bill';
  static const String toggleShowOnBillSub    = 'Print CGST / SGST / IGST breakdown on customer invoice';
  static const String toggleCompositeTitle   = 'Composite Supply Treatment';
  static const String toggleCompositeSub     = 'Treat jewellery + making charge as composite supply';
  static const String toggleTcsTitle         = 'Enable TCS Collection (Sec 206C)';
  static const String toggleTcsSub           = 'Collect 1% TCS on jewellery sales above threshold — mandatory';
  static const String toggleTdsTitle         = 'Enable TDS Deduction';
  static const String toggleTdsSub           = 'Deduct TDS on applicable purchase transactions';
  static const String toggleEInvoiceTitle    = 'Enable E-Invoicing';
  static const String toggleEInvoiceSub      = 'Generate IRN & QR code for all B2B invoices via IRP portal';
  static const String toggleGstr1Title       = 'GSTR-1 Filing Reminder';
  static const String toggleGstr1Sub         = 'Monthly notification on 10th for outward supply filing';
  static const String toggleGstr3bTitle      = 'GSTR-3B Filing Reminder';
  static const String toggleGstr3bSub        = 'Monthly notification on 20th for summary return filing';
  ...
  static const String snackValidationError = 'Please fix the errors before saving.';
  static const String snackHsnAdded      = 'HSN code added successfully';
  static const String snackHsnRemoved    = 'HSN code removed';

  // ── Validation Messages ──────────────────────────────────────
  static const String validGstinFormat   = 'Invalid GSTIN format (e.g. 27AAAAA0000A1Z5)';
  ...
  static const String emptyHsnSub        = 'Add HSN codes to map product categories for GST returns';
