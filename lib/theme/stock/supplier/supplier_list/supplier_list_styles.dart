...
class SupplierListStyles {
  ...
  static TextStyle get appBarTitle => GoogleFonts.inter(
    ...
    color: SupplierListColors.shellTextTitle, letterSpacing: 0.8,
  );
  ...
  static TextStyle get statsValue => GoogleFonts.manrope(
    ...
    color: SupplierListColors.bodyTextMain, height: 1.0,
  );

  static TextStyle get statsLabel => GoogleFonts.inter(
    fontSize: 12, fontWeight: FontWeight.w600,
    color: SupplierListColors.bodyTextMuted, letterSpacing: 0.5,
  );
  ...
  static TextStyle get searchHint => GoogleFonts.inter(
    fontSize: 14, color: SupplierListColors.bodyTextMuted,
  );
  ...
  static TextStyle get supplierMobile => GoogleFonts.inter(
    ...
    color: SupplierListColors.bodyTextMain, letterSpacing: 0.5,
  );
  ...
  static TextStyle get typeBadge => GoogleFonts.inter(
    ...
    color: SupplierListColors.manufacturerText, letterSpacing: 0.8,
  );
  ...
  static BoxDecoration get cardDecoration => BoxDecoration(
    ...
    border: Border.all(color: SupplierListColors.bodyBorder.withOpacity(0.5)),
    boxShadow: const [BoxShadow(color: SupplierListColors.shadowLight, blurRadius: 12, offset: Offset(0, 4))],
  );
  ...
  static BoxDecoration get cardDecorationHover => BoxDecoration(
    ...
    boxShadow: [BoxShadow(color: SupplierListColors.brandGold.withOpacity(0.15), blurRadius: 20, offset: const Offset(0, 8))],
  );
  ...
  static BoxDecoration get searchDecoration => BoxDecoration(
    ...
    boxShadow: const [BoxShadow(color: SupplierListColors.shadowLight, blurRadius: 10, offset: Offset(0, 2))],
  );
  ...
  static BoxDecoration get statsCardDecoration => BoxDecoration(
    ...
    border: Border.all(color: SupplierListColors.bodyBorder.withOpacity(0.5)),
    boxShadow: const [BoxShadow(color: SupplierListColors.shadowLight, blurRadius: 15, offset: Offset(0, 6))],
  );
}