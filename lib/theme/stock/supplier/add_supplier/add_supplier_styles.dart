...
class AddSupplierStyles {
  ...
  static TextStyle get fieldHint =>
      GoogleFonts.inter(fontSize: 13, color: AddSupplierColors.inputHint);
  ...
  static BoxDecoration get heroDecoration => BoxDecoration(
        gradient: LinearGradient(
          colors: [
            AddSupplierColors.brandGold.withValues(alpha: 0.15),
            AddSupplierColors.brandGold.withValues(alpha: 0.04),
          ],
        ...
        border: Border.all(
          color: AddSupplierColors.brandGold.withValues(alpha: 0.30),
          width: 1.5,
        ),
        boxShadow: [
          BoxShadow(
            color: AddSupplierColors.brandGold.withValues(alpha: 0.12),
            blurRadius: 20,
      ...
      InputDecoration(
        ...
        focusedBorder: OutlineInputBorder(
          ...
          borderSide: const BorderSide(
            color: AddSupplierColors.inputBorderFocus,
            width: 1.5,
          ),
        ),
