// =============================================================================
// FILE        : Gold_stock_strings.dart
// MODULE      : Stock & Inventory (Gold)
// LAYER       : Theme / Strings
// DESCRIPTION : Centralized string dictionary for Gold Module.
//               Full parity with AddStockStrings (Gold).
// =============================================================================

class GoldStockStrings {
  GoldStockStrings._();

  // ── SCREEN HEADER ────────────────────────────────────────────
  static const String screenTitle = 'ADD STOCK';
  static const String screenSubtitle = 'Register new Gold items into inventory';
  ...
  // ── RIGHT BILLING PANEL ──────────────────────────────────────
  static const String billingLiveRate = 'Live Gold Rate';
  ...
  static const String paymentModesSubtitle =
      'Choose how this Gold batch is being settled.';
  ...
  static const String invoiceSnapshotSubtitle =
      'Every entered Gold line is listed exactly as it will be billed.';
  ...
  static const String todayGoldRateLabel = 'Today Gold Rate';
