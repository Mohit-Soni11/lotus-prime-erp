// =============================================================================
// FILE        : Gold_stock_icons.dart
// MODULE      : Stock & Inventory (Gold)
// LAYER       : Theme / Icons
// DESCRIPTION : Isolated icon set for Gold Add Stock module.
//               Full parity with AddStockIcons (Gold).
// =============================================================================

import 'package:flutter/material.dart';

class GoldStockIcons {
  GoldStockIcons._();
  ...
  static const IconData stockModule = Icons.water_drop_outlined; // Gold drop
