...
class DayBookColors {
  ...
  static const Color positiveSoft = Color(0xFFEAF7F1);
  static const Color positiveBorder = Color(0xFFBFE5D3);

  static const Color negative = Color(0xFFC63F3F);
  static const Color negativeSoft = Color(0xFFFCEEEE);
  static const Color negativeBorder = Color(0xFFF0CACA);

  static const Color information = Color(0xFF316BD6);
  static const Color informationSoft = Color(0xFFEDF3FD);
  static const Color informationBorder = Color(0xFFC9D9F5);

  static const Color warning = Color(0xFFA86508);
  static const Color warningSoft = Color(0xFFFFF6E7);
  static const Color warningBorder = Color(0xFFF2D6A8);

  static const Color purple = Color(0xFF7055B5);
  static const Color purpleSoft = Color(0xFFF2EFFA);
  static const Color purpleBorder = Color(0xFFD9D0EF);

  static const Color goldMetal = Color(0xFFB7791F);
  ...
  static const Color cardMode = Color(0xFF6658C7);
