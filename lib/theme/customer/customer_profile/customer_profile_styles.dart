...
class CustomerProfileStyles {
  ...
  static TextStyle get appBarTitle => GoogleFonts.inter(
    ...
    color: CustomerProfileColors.shellTextTitle, letterSpacing: 0.8,
  );
 
  static TextStyle get appBarSubtitle => GoogleFonts.inter(
    fontSize: 11, fontWeight: FontWeight.w600,
    color: CustomerProfileColors.brandGold, letterSpacing: 1.5,
  );
  ...
  static TextStyle get customerName => GoogleFonts.manrope(
    ...
    color: CustomerProfileColors.bodyTextMain, letterSpacing: -0.3,
  );
  ...
  static TextStyle get sectionSubtitle => GoogleFonts.inter(
    ...
    color: CustomerProfileColors.bodyTextMuted, letterSpacing: 1.2,
  );
  ...
  static TextStyle get creditAmount => GoogleFonts.manrope(
    ...
    color: CustomerProfileColors.bodyTextMain, height: 1.0,
  );
 
  static TextStyle get creditLabel => GoogleFonts.inter(
    fontSize: 11, color: CustomerProfileColors.bodyTextMuted,
  );
  ...
  static BoxDecoration get cardDecoration => BoxDecoration(
    ...
    boxShadow: const [
      BoxShadow(color: CustomerProfileColors.shadowLight, blurRadius: 10, offset: Offset(0, 3)),
    ],
  );
  ...
  static BoxDecoration get avatarDecoration => BoxDecoration(
    ...
    border: Border.all(color: CustomerProfileColors.brandGold.withOpacity(0.4), width: 2),
    boxShadow: [
      BoxShadow(
        color: CustomerProfileColors.brandGold.withOpacity(0.2),
