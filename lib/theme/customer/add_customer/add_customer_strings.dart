...
class AddCustomerStrings {
  ...
  static const String pageSubtitle   = "Fill in the details to register a new customer";
  ...
  static const String errMobileInvalid = "Mobile number must contain only digits";
