...
class KarigarStyles {
  ...
  static BoxDecoration get cardDecoration => BoxDecoration(
    ...
    boxShadow: const [
      BoxShadow(color: KarigarColors.shadowLight, blurRadius: 12, offset: Offset(0, 4)),
      BoxShadow(color: KarigarColors.shadowMedium, blurRadius: 4, offset: Offset(0, 1)),
    ],
  );
  ...
  static BoxDecoration cardWithAccent(Color accent) => BoxDecoration(
    ...
    boxShadow: [
      BoxShadow(color: accent.withOpacity(0.08), blurRadius: 20, spreadRadius: 2, offset: const Offset(0, 4)),
      const BoxShadow(color: KarigarColors.shadowMedium, blurRadius: 8, offset: Offset(0, 2)),
    ],
  );
  ...
  static BoxDecoration get inputFocused => BoxDecoration(
    ...
    boxShadow: [
      BoxShadow(color: KarigarColors.brandGold.withOpacity(0.15), blurRadius: 8, offset: const Offset(0, 2)),
    ],
  );
  ...
  static BoxDecoration get inputDisabled => BoxDecoration(
    ...
    borderRadius: BorderRadius.circular(10),
    border: Border.all(color: KarigarColors.cardBorder.withOpacity(0.5), width: 1),
  );
  ...
  static const BoxDecoration shellDecoration = BoxDecoration(
    ...
    border: Border(bottom: BorderSide(color: KarigarColors.shellBorder, width: 1)),
  );
  ...
  static const BoxDecoration leftPanelDecoration = BoxDecoration(
    ...
    border: Border(right: BorderSide(color: KarigarColors.leftPanelBorder, width: 1)),
  );
  ...
  static BoxDecoration get jobCard => BoxDecoration(
    ...
    border: Border.all(color: KarigarColors.cardBorder, width: 1),
    boxShadow: const [
      BoxShadow(color: KarigarColors.shadowLight, blurRadius: 10, offset: Offset(0, 3)),
    ],
  );
