...
class KarigarColors {
  ...
  static const Color goldGradientStart =
      Color(0xFFFFD700); // Extracted Premium Gradient
  ...
  static const Color accentKarigar =
      Color(0xFFD4AF37); // Gold — Karigar selection
  ...
  static const Color accentWastage =
      Color(0xFFEF4444); // Red — Wastage analysis
  static const Color accentCharges =
      Color(0xFF9C6FDE); // Purple — Making charges
