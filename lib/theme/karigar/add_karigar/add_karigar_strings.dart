...
class AddKarigarStrings {
  ...
  static const String photoAuto =
      'Initials avatar will be used as placeholder.';
  ...
  static const String statusInactiveHint =
      'Karigar will not appear in job assignments';
}
