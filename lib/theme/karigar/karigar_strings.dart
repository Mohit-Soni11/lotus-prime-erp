...
class KarigarStrings {
  ...
  static const String descSelectKarigar =
      'Choose the artisan for this transaction';
  ...
  static const String descMetalDetails =
      'Metal type, purity and weight breakdown';
  ...
  static const String noteSelectKarigar =
      'Tap to select a karigar from the list';
  ...
  static const String noteWastageCritical =
      'CRITICAL: Wastage above 5% — verify weights';
  static const String noteOpeningBalance =
      'Positive = we owe karigar. Negative = karigar owes us.';

  // ── EMPTY STATES ─────────────────────────────────────────────────────────
  static const String emptyJobsTitle = 'No Pending Jobs';
  static const String emptyJobsSub =
      'All jobs are up to date or no issues recorded yet.';
  ...
  static const String emptyLedgerSub =
      'Issue gold to this karigar to start the ledger.';
  static const String emptySearchTitle = 'No Results Found';
  static const String emptySearchSub =
      'Try a different name, phone, or issue number.';
  ...
  static const String ledgerSelectPrompt =
      'Select a karigar to view their hisaab';
