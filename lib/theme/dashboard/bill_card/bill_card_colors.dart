...
class BillCardColors {
  ...
  static const Color iconBoxBorder = Color(0x33F59E0B); // Low opacity gold border
  ...
  // --- GLOWS & SHADOWS ---
  static const Color borderHighlight = Color(0x1AFFFFFF); // Top White Highlight (Glass effect)
