...
class BillCardStyles {
  // ✅ FIXED: Increased to 150.0 for comfortable fit
  ...
  static BoxDecoration get premiumCardDecoration => BoxDecoration(
    ...
    boxShadow: const [
      ...
      BoxShadow(color: BillCardColors.glowTopRight, blurRadius: 10, spreadRadius: 0, offset: Offset(0, 0)),
    ],
  );

  static BoxDecoration iconBoxDecoration = BoxDecoration(
    color: BillCardColors.iconBoxBg.withOpacity(0.5),
