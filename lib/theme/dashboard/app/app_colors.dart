...
class AppColors {
  ...
  Color get glassBase => _slate800.withValues(alpha: 0.6);
  Color get glassBorder => const Color(0xFFFFFFFF).withValues(alpha: 0.08);
  Color get overlayDark =>
      const Color(0xFF000000).withValues(alpha: 0.3); // For Left Panel

  // Ambient Glows
  Color get glowPrimary => _goldMain.withValues(alpha: 0.3);
  Color get glowAccent => _blueGlow.withValues(alpha: 0.2);
  ...
  // Success Badge Style
  Color get successBg => _success.withValues(alpha: 0.1);
  Color get successBorder => _success.withValues(alpha: 0.3);
}
