...
class CounterSecurityColors {
  ...
  static Color metalActiveColor(SecurityMetal m) {
    switch (m) {
      case SecurityMetal.gold:     return goldChipActive;
      case SecurityMetal.silver:   return silverChipActive;
      case SecurityMetal.platinum: return platinumChipActive;
      case SecurityMetal.diamond:  return diamondChipActive;
    }
  }
}