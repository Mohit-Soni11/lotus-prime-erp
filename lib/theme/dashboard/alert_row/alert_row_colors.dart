...
class AlertRowColors {
  ...
  static Color accentFor(AlertStatus s) {
    switch (s) {
      case AlertStatus.critical: return criticalAccent;
      case AlertStatus.warning:  return warningAccent;
      case AlertStatus.safe:     return safeAccent;
    }
  }

  static Color accentDimFor(AlertStatus s) {
    switch (s) {
      case AlertStatus.critical: return criticalAccentDim;
      case AlertStatus.warning:  return warningAccentDim;
      case AlertStatus.safe:     return safeAccentDim;
    }
  }

  static Color badgeBgFor(AlertStatus s) {
    switch (s) {
      case AlertStatus.critical: return criticalBadgeBg;
      case AlertStatus.warning:  return warningBadgeBg;
      case AlertStatus.safe:     return safeBadgeBg;
    }
  }

  static Color badgeTextFor(AlertStatus s) {
    switch (s) {
      case AlertStatus.critical: return criticalBadgeText;
      case AlertStatus.warning:  return warningBadgeText;
      case AlertStatus.safe:     return safeBadgeText;
    }
  }

  static String badgeLabelFor(AlertStatus s) {
    switch (s) {
      case AlertStatus.critical: return 'ACTION NEEDED';
      case AlertStatus.warning:  return 'ATTENTION';
      case AlertStatus.safe:     return 'NORMAL';
    }
  }

  static double severityFillFor(AlertStatus s) {
    switch (s) {
      case AlertStatus.critical: return 1.0;
      case AlertStatus.warning:  return 0.58;
      case AlertStatus.safe:     return 0.18;
    }
  }
}