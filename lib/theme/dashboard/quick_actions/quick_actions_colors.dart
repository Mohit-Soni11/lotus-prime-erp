...
class QuickActionsColors {
  ...
  // HEADER
  // ==========================================
  static const Color headerText = Color(0xFFD4AF37);     // Gold — matches shop card
  static const Color headerLetterSpacing = Color(0xFFD4AF37);

  // ==========================================
  // ACTION BUTTON (Cream background — Python QA_BG matches this)
  // ==========================================
  static const Color btnBg = Color(0xFFF4F1E8);          // Cream — exactly Python CARD_CREAM
  static const Color btnText = Color(0xFF1A2238);         // Dark Blue — exactly Python TEXT_DARK_BLUE
  static const Color btnIconDefault = Color(0xFF1A2238);  // Dark
  static const Color btnBorderDefault = Color(0x22C8A660); // Gold border, subtle

  // Button pressed state
  static const Color btnBgPressed = Color(0xFFE8E3D5);   // Slightly darker cream
  static const Color btnBorderPressed = Color(0xFFC8A660); // Gold border visible
  ...
  // ==========================================
  // GLOW (ambient background glow — like BillCard)
  // ==========================================
  ...
  static Color iconCircleBg(Color accent) => accent.withOpacity(0.12);
  static Color btnShadow = Colors.black.withOpacity(0.18);
}