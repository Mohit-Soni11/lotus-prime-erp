...
class DateCardStyles {
  // ✅ FIXED: Strict Match with Bill Card
  ...
  static BoxDecoration get premiumCardDecoration => BoxDecoration(
    ...
    boxShadow: const [
      ...
      BoxShadow(color: DateCardColors.glowColor1, blurRadius: 10, spreadRadius: 0, offset: Offset(0, 0)),
    ],
  );
  
  static BoxDecoration iconBoxDecoration = BoxDecoration(
    color: DateCardColors.iconBoxBg.withOpacity(0.5),
