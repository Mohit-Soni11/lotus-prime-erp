...
class PaymentStatusColors {
  ...
  static Color accentFor(PaymentStatus s) {
    switch (s) {
      case PaymentStatus.paid:    return paidAccent;
      case PaymentStatus.partial: return partialAccent;
      case PaymentStatus.unpaid:  return unpaidAccent;
    }
  }

  static Color accentDimFor(PaymentStatus s) {
    switch (s) {
      case PaymentStatus.paid:    return paidAccentDim;
      case PaymentStatus.partial: return partialAccentDim;
      case PaymentStatus.unpaid:  return unpaidAccentDim;
    }
  }

  static Color badgeBgFor(PaymentStatus s) {
    switch (s) {
      case PaymentStatus.paid:    return paidBadgeBg;
      case PaymentStatus.partial: return partialBadgeBg;
      case PaymentStatus.unpaid:  return unpaidBadgeBg;
    }
  }

  static Color badgeTextFor(PaymentStatus s) {
    switch (s) {
      case PaymentStatus.paid:    return paidBadgeText;
      case PaymentStatus.partial: return partialBadgeText;
      case PaymentStatus.unpaid:  return unpaidBadgeText;
    }
  }
