...
class PaymentStatusStyles {
  ...
  static BoxDecoration get cardDecoration => BoxDecoration(
    gradient: const LinearGradient(
      ...
      colors: [PaymentStatusColors.cardBgStart, PaymentStatusColors.cardBgEnd],
    ),
  ...
  // ── BILL ROW DECORATION ───────────────────────────────────────────────────
  static BoxDecoration rowDecoration(PaymentStatus s, {bool isPressed = false}) {
    return BoxDecoration(
      color: isPressed
          ? PaymentStatusColors.accentFor(s).withOpacity(0.06)
          : PaymentStatusColors.rowBg,
      borderRadius: BorderRadius.circular(rowBorderRadius),
      border: Border.all(
        color: isPressed
            ? PaymentStatusColors.accentFor(s).withOpacity(0.3)
  ...
  static BoxDecoration avatarDecoration(PaymentStatus s) => BoxDecoration(
    ...
    border: Border.all(
      color: PaymentStatusColors.accentFor(s).withOpacity(0.35),
    ),
  );
  ...
  static BoxDecoration badgeDecoration(PaymentStatus s) => BoxDecoration(
    ...
    border: Border.all(
      color: PaymentStatusColors.accentFor(s).withOpacity(0.3),
    ),
  );
