...
class AddressValidators {
  ...
  // --- GENERIC VALIDATOR ---
  static String? requiredField(String? val, String fieldName, {int? minLength, int? maxLength}) {
  ...
  static String? cityOrState(String? val, String fieldName) {
    ...
    final requiredCheck = requiredField(val, fieldName, minLength: 2, maxLength: 50);
