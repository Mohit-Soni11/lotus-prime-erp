    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Switch between Gold, Silver, Diamond and Platinum billing controls.',
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              final columns = (constraints.maxWidth / 220)
                  .floor()
                  .clamp(1, SalesBillingMetalProfiles.all.length)
                  .toInt();
              const gap = 12.0;
              final itemWidth =
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Image.asset(
                SalesBillingVisuals.logoAssetFor(profile.metal),
                fit: BoxFit.cover,
                width: 36,
                height: 36,
