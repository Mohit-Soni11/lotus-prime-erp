...
class PurchaseBillingHeader extends StatelessWidget {
  final VoidCallback onBack;

  const PurchaseBillingHeader({
    super.key,
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            height: 42,
            decoration: BoxDecoration(
              color: BillingSetupDesignTokens.purchase.withValues(alpha: 0.14),
              borderRadius: BorderRadius.circular(8),
              border: Border.all(
                color:
                    BillingSetupDesignTokens.purchase.withValues(alpha: 0.36),
              ),
            ),
            child: const Icon(
