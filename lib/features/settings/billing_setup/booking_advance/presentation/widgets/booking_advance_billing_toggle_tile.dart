...
class BookingAdvanceBillingToggleTile extends StatelessWidget {
  final String label;
  ...
  const BookingAdvanceBillingToggleTile({
    super.key,
    required this.label,
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color:
              value ? accent.withValues(alpha: 0.25) : const Color(0xFFE5E7EB),
        ),
      ),
      child: Column(
