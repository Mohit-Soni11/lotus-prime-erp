...
class CustomerMetalPurchaseLedgerAppBar extends StatefulWidget
  ...
  @override
  State<CustomerMetalPurchaseLedgerAppBar> createState() =>
      _CustomerMetalPurchaseLedgerAppBarState();
}

class _CustomerMetalPurchaseLedgerAppBarState
    extends State<CustomerMetalPurchaseLedgerAppBar>
      ...
      child: SafeArea(
        ...
        child: Row(
          children: [
            ...
            _SystemOnlineBadge(controller: _radarController),
          ],
        ),
      ),
    );
