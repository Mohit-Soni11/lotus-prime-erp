...
// DESCRIPTION: Full Supplier List screen â€” identical structure to CustomerListScreen.
...
import 'package:lotus_erp/features/stock/shared/application/supplier_list_logic.dart';
...
class _SupplierListScreenState extends State<SupplierListScreen> {
  ...
  // â”€â”€ STATS DASHBOARD â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                        ...
                        children: [
                          Text(stats.isLoading ? '--' : stats.total.toString(),
                              style: SupplierListStyles.statsValue),
                          const SizedBox(height: 2),
                          Text(SupplierListStrings.totalSuppliers,
                              style: SupplierListStyles.statsLabel),
                        ]),
                  ),
                ],
              ),
                    ...
                    Row(children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                            color: SupplierListColors.successBg,
                            borderRadius: BorderRadius.circular(8)),
                        child: const Icon(SupplierListIcons.todayNew,
                            size: 14, color: SupplierListColors.success),
                      ),
                      const Spacer(),
                      Text(stats.isLoading ? '--' : stats.todayCount.toString(),
                          style: SupplierListStyles.statsValue),
                    ]),
                    const SizedBox(height: 12),
                    Text(SupplierListStrings.todayNew,
                        style: SupplierListStyles.statsLabel),
                  ]),
            ),
          ),
                  ...
                  children: [
                    Row(children: [
                      Container(
                        padding: const EdgeInsets.all(6),
                        decoration: BoxDecoration(
                            color: SupplierListColors.manufacturerBg,
                            borderRadius: BorderRadius.circular(8)),
                        child: const Icon(SupplierListIcons.manufacturer,
                            size: 14,
                      ...
                      Text(
                          stats.isLoading
                              ? '--'
                              : stats.manufacturerCount.toString(),
                          style: SupplierListStyles.statsValue),
                    ]),
                    const SizedBox(height: 12),
                    Text(SupplierListStrings.manufacturerCount,
                        style: SupplierListStyles.statsLabel),
                  ]),
            ),
          ),
          ...
          Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: const Icon(SupplierListIcons.search,
                    color: SupplierListColors.bodyTextMuted, size: 22),
                suffixIcon: _logic.isSearching
                    ? IconButton(
                        icon: const Icon(SupplierListIcons.clearSearch,
                            color: SupplierListColors.bodyTextMuted, size: 20),
                        onPressed: () {
                          _searchCtrl.clear();
                          _logic.clearSearch();
                        })
                ...
                return Padding(
                  ...
                  child: GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        color: isActive
                            ? SupplierListColors.chipActiveBg
                            : SupplierListColors.chipInactiveBg,
                        borderRadius: BorderRadius.circular(
                            SupplierListStyles.chipBorderRadius),
                        border: Border.all(
                            color: isActive
                                ? SupplierListColors.chipActive
                                : Colors.transparent),
                      ),
                      child: Text(filter.label,
                          style: isActive
                              ? SupplierListStyles.chipActive
                              : SupplierListStyles.chipInactive),
                    ),
                  ),
                );
              }).toList(),
  ...
  Widget _buildResultCount() {
    if (_logic.state == SupplierListState.loading) {
  ...
  Widget _buildBody() {
    switch (_logic.state) {
      ...
      case SupplierListState.searching:
        return const Center(
            child:
                CircularProgressIndicator(color: SupplierListColors.brandGold));
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return SupplierListCard(
              supplier: s,
              onTap: () {
                if (widget.onSupplierTap != null) widget.onSupplierTap!(s.id);
              },
            );
          },
        );
    ...
    return Center(
      child: Column(
        ...
        children: [
          Icon(
              _logic.isSearching
                  ? SupplierListIcons.noResult
                  : SupplierListIcons.emptyState,
              size: 64,
              color: SupplierListColors.bodyTextMuted.withValues(alpha: 0.5)),
          const SizedBox(height: 16),
          Text(
              _logic.isSearching
                  ? SupplierListStrings.noResultTitle
                  : SupplierListStrings.emptyTitle,
              style: SupplierListStyles.emptyTitle),
          const SizedBox(height: 8),
          Text(
              _logic.isSearching
                  ? SupplierListStrings.noResultSub
                  : SupplierListStrings.emptySubtitle,
          ...
          if (!_logic.isSearching) ...[
            ...
            ElevatedButton.icon(
              ...
              label: const Text(SupplierListStrings.addFirst,
  ...
  Widget _buildFab() {
    return FloatingActionButton.extended(
      ...
      label: const Text(SupplierListStrings.btnAddNew,
          style: TextStyle(fontWeight: FontWeight.w800)),
    );
  }
}
