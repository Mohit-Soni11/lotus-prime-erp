...
class _StockActivityAppBar extends StatefulWidget
    implements PreferredSizeWidget {
  final VoidCallback onBack;
  final VoidCallback onRefresh;

  const _StockActivityAppBar({
  ...
  @override
  State<_StockActivityAppBar> createState() => _StockActivityAppBarState();
}

class _StockActivityAppBarState extends State<_StockActivityAppBar>
