  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: const BoxDecoration(
        border: Border(bottom: BorderSide(color: SilverStockColors.cardBorder)),
      ),
      child: Row(
        children: [
          Container(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  hasSupplier
                      ? 'Supplier linked with this silver batch'
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: Padding(
                  ...
                  child: Container(
                    ...
                    height: 24,
                    decoration: BoxDecoration(
                      color: SilverStockColors.brandSilver.withValues(
                        alpha: 0.10,
                      ),
...
class _SupplierStateBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final color =
        linked ? SilverStockColors.success : SilverStockColors.warning;
    final bg =
        linked ? SilverStockColors.successBg : SilverStockColors.warningBg;
    final icon =
            ...
            children: [
              ...
              if (secondaryActionLabel != null && onSecondaryAction != null)
                TextButton(
                  ...
                  style: TextButton.styleFrom(
                    foregroundColor: SilverStockColors.textMuted,
                    padding:
                        const EdgeInsets.symmetric(horizontal: 10, vertical: 7),
                    minimumSize: Size.zero,
                    tapTargetSize: MaterialTapTargetSize.shrinkWrap,
